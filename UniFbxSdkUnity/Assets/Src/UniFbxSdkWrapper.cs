...
namespace UniFbxSdkNet
{
    ...
    public static class UniFbxSdkWrapper
    {
        ...
        {
            if (p_length < 0 || p_length > p_data.Length)
            {
                return string.Empty;
            }
        ...
        {
            //UnityEngine.Debug.Log(string.Format("{0} begin  {1}", p_path, DateTime.Now.ToString("HH:mm:ss ffff")));
            ...
            if (info.Exists)
            {
                ...
                //UnityEngine.Debug.Log(string.Format("{0} end  {1}", p_path, DateTime.Now.ToString("HH:mm:ss ffff")));
        ...
        private static UniGameObjectWrapper ParseGameObject(FbxNodeRef fbxNodeRef, string path)
        {
            ...
            //UnityEngine.Debug.Log(string.Format("{0} begin  {1}", path, DateTime.Now.ToString("HH:mm:ss ffff")));
            ...
            //UnityEngine.Debug.Log(string.Format("{0} end  {1}", path, DateTime.Now.ToString("HH:mm:ss ffff")));
